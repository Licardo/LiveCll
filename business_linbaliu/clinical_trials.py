...
class ClinicalTrials(NetPost):
    ...
    def get_data_plugin(self):
        url = 'https://mp.weixin.qq.com/mp/homepage?__biz=MjM5ODcyNTMyMA==&hid=5&sn=c6b4db3af4fa6ef63f70ed8e66115839&' \
              'begin=%d&count=%d&action=appmsg_list&f=json&r=0.24863835986195526&appmsg_token=' % \
              (self.page_index, self.page_count)
        data = {'__biz': 'MjM5ODcyNTMyMA==', 'hid': '6', 'sn': '050be7401f9cf2042204e77955c1ae86',
                'begin': self.page_index, 'count': self.page_count, 'action': 'appmsg_list',
